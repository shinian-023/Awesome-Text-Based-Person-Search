...
<!-- Taxonomy rows are combined into one HTML table so GitHub keeps Title / Model / Date / Link / Venue aligned. -->
...
<!-- IMPORTANT: The taxonomy is intentionally rendered as ONE table. GitHub recalculates column widths for each separate table and may ignore HTML width attributes, which causes misalignment. Keeping all taxonomy rows inside a single table forces Title / Model / Date / Link / Venue to share the same columns. -->
...
<table width="100%">
  ...
  <tbody>
    <tr>
      <td colspan="5"><a id="external-knowledge"></a><strong>External Knowledge</strong></td>
    </tr>
    <tr>
      <td colspan="5"><em>Pose Knowledge</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Attribute Knowledge</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Color Knowledge</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Body Parts Knowledge</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><a id="learning-objectives"></a><strong>Learning Objectives</strong></td>
    </tr>
    <tr>
      <td colspan="5"><em>Identity (ID) Loss</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Matching Loss</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Ranking Loss</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Adversarial Loss</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>MLM/MIM Loss</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Other Loss</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><a id="encoder"></a><strong>Encoder</strong></td>
    </tr>
    <tr>
      <td colspan="5"><em>CNN-RNN/CNN-BERT Encoders</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Transformer-Based Encoders</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>VLM-Based Encoders</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><a id="modality-interaction"></a><strong>Modality Interaction</strong></td>
    </tr>
    <tr>
      <td colspan="5"><em>Intra-Modality Interaction</em></td>
    </tr>
    <tr>
      <td colspan="5"><em>Visual Intra-modal Interaction</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Textual Intra-modal Interaction</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Dual Intra-modal Interaction</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Inter-Modality Interaction</em></td>
    </tr>
    <tr>
      <td colspan="5"><em>Global Feature Interaction</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Local Feature Interaction</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Multi-Granularity Feature Interaction</em></td>
    </tr>
    <tr>
    <td align="left" width="62%"><a href="https://scholar.google.com/scholar?q=Improving%20Description-based%20Person%20Re-identification%20by%20Multi-granularity%20Image-Text%20Alignments"><strong>Improving Description-based Person Re-identification by Multi-granularity Image-Text Alignments</strong></a></td>
    <td align="center" width="10%">MIA</td>
    ...
    <tr>
      <td colspan="5"><em>Proxy Task-Guided Interaction</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Large Model-Driven Interaction</em></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5"><em>Hybrid Interaction Approach</em></td>
    </tr>
    <tr>
